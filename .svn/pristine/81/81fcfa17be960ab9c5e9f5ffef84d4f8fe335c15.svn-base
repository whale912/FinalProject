                                    ...
                                    <div class="card-body">
                                        ...
                                        <p style="font-size:10px;" class="text-danger"><span class="badge-dot badge-danger"></span>&nbsp;는 필수 입력 표시입니다</p>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="empno" name="empno" value="${mem.empno}" type="text" class="form-control" readonly style="width:40%">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div style="width:20%;float:left">
                                                	<input name="personnel" id="personnel" type="number" class="form-control" placeholder="인원(명)" style="width:100%;text-align:right">
                                                </div>
                                            ...
                                            <div class="form-group" style="margin-top:20px;">
                                                ...
                                                <div style="width:20%;float:left">
                                                	<input id="budget" name="budget" type="text" class="form-control" placeholder="예산(원)" style="width:100%;text-align:right">
                                            	</div>
