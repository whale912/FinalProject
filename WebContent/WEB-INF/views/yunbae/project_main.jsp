...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <!-- wrapper  -->ㅣ
        <!-- ============================================================== -->
        <div class="dashboard-wrapper" style="height:854px">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content " style="height:824px;">
                    <!-- ============================================================== -->
                    <!-- pageheader  -->
                    <!-- ============================================================== -->
                    <div class="row">
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">                            
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
		                        <div class="card">
		                            <h5 class="card-header">프로젝트 관리<span style="margin-left:10px;color:red;font-size:13px;">표의 각 행을 더블 클릭 시 프로젝트 상세 페이지로 이동합니다</span><input id="create_pro" type="button" style="float:right;" class="btn btn-primary" value="생성"/></h5>
		                            <div class="card-body">
