...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <!-- wrapper  -->
        <!-- ============================================================== -->
        <div class="dashboard-wrapper" style="height:980px">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content " style="height:950px; background-color:#efeff6;">
                    <!-- ============================================================== -->
                    <!-- pageheader  -->
                    <!-- ============================================================== -->
                    <div class="row">
                            	...
                            	<div class="card" style="width:900px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p style="font-size:10px;" class="text-danger"><span class="badge-dot badge-danger"></span>&nbsp;는 필수 입력 표시입니다</p>
                                        	...
                                        	<div class="form-group">
                                                <label for="state"><span class="badge-dot badge-danger"></span>&nbsp;프로젝트 상태</label>
                                                <select class="form-control" id="p_state" name="state" style="width:40%;">
                                                    <option>진행</option>
                                                    <option>종료</option>
                                                    <option>중단</option>
                                                    <option>취소</option>
