							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
		                        <div class="card">
		                            ...
		                            <form:hidden path="memauthno" value="${mem.authno}"/>
			                            ...
			                            <label>
			                            	<select class="form-control" id="input-select" name="projectno" onchange="this.form.submit();" style="-webkit-appearance:button;">
			                            	...
			                            	&nbsp;&nbsp;
			                            	&nbsp;&nbsp;
			                            	<c:if test="${mem.authno==1&&plist0.projectno!=null}">
		                                    ...
		                                    <table class="table table-striped table-bordered first">
		                                        ...
		                                        <c:forEach var="i" items="${ilist}" varStatus="sts">
		                                            ...
		                                            <tr ondblclick="javascript:goDetail2(${i.issueno},${i.measureno})">
		                                                ...
		                                                <td style="cursor:pointer;">${i.pname}</td>
		                                                <td style="cursor:pointer;">${i.tname}</td>
