													...
													<table class="table table-striped table-bordered first" >
														<thead>
															<tr >
																...
																<th style="text-align: center;font-weight:bold;">작성자</th>
																<th style="text-align: center;font-weight:bold;">등록일</th>
																<th style="text-align: center;font-weight:bold;">조회수</th>
														...
														<tbody>
															<c:forEach var="board" items="${blist}">
																...
																<tr  onclick="javascript:go(${board.pjboardno})"
																	...
																	<c:choose>
																		<c:when test="${board.noticetype eq 'Y'}">
																			<td width="55%" style="text-align: left; padding-left:320px;">${board.title} <span class="badge badge-danger" style="margin-left:10px;">&nbsp;${board.totrecnt}&nbsp;</span></td>
																		</c:when>
																		<c:otherwise>
																			<td width="55%" style="text-align: left;padding-left:320px;">${board.title}<span class="badge badge-danger" style="margin-left:10px;">&nbsp;${board.totrecnt}&nbsp;</span></td>
																		</c:otherwise>
