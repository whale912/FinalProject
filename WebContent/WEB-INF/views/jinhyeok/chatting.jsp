...
#writeBtn:hover {
	...
	#chatArea{
		width:80%;height:600px;overflow-y:auto;text-align:left;border:1px solid green;
	}
										...
										function() {
											if (confirm("채팅서버에 접속합니다!")) {
												...
												$("#exitBtn")
														.click(
																function() {
																	wsocket.send("msg:"+ $("#id").val()+ ": 접속을 종료하였습니다");
																	wsocket.close();				
																});					
												...
												function receiveMsg(msg) {
													...
													$("#chatMessageArea").append(today.toLocaleString()+"\t\t\t\t\t\t\t"+ msg+"<hr>");
