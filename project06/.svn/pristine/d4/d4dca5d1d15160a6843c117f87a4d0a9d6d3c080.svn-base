...
public class ProjectCtrl {
	...
	@RequestMapping(params="method=mlist")
	public String getMlist(@RequestParam("projectno") int projectno, Model d) {
	...
	@RequestMapping(params="method=reqlist")
	public String getReqConApp(@RequestParam("empno") String empno, Model d) {
		d.addAttribute("tlist",service.getReqConApp(empno));
		return "pageJsonReport";
	}
