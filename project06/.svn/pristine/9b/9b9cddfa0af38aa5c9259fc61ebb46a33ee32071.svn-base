    ...
    <div class="dashboard-main-wrapper" style="height:830px">
        ...
        <div class="dashboard-wrapper" style="height:830px">
	                                          		...
	                                          		<div class="select_group" style="float:left; overflow:hidden; ">                                   		
			                                        	<div class="form-group" style="width:200px; display:inline-block; overflow:hidden;">                                               
			                           					...
			                           					<div class="search_regist" style="float:right; margin:0px 0px 0px 30px; overflow:hidden;">
			                           						...
			                           						<input style="overflow:hidden; width:250px; height:38px; float:left;" class="form-control form-control-lg" type="text"  value="${param.name }"placeholder="사원명" name="name" aria-label="Search"/>
            ...
            <div id="dialog-form01" title="등록">
             ...
             <!-- 직급 수정하기 -->	    
            	 <form id="updateRanPosi" name="update" method="post" action="${path}/mlist.do?method=update">
            	   
            	    <input type="hidden" id="updateRank" name="empno"/>
            	   
            	    <label for="title" style="font-weight:bold; margin-top:10px;">직급 수정</label><br>
            	    <select class="form-control" name="rankno">
	            	    <option value="1">사원</option>
	            		<option value="2">대리</option>
	            		<option value="3">과장</option>
				...
				<!--  
            		<input type="hidden" id="updatePosition" name="empno"/>
            	-->	
