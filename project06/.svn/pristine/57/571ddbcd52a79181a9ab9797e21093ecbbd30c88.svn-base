													...
													<br>
														...
														<div class="form-group">
															...
															<div id="show">
																<div class="input2">
																	<span class="badge-dot badge-danger"></span> <label
																		for="selectDiv" class="col-form-label">유형</label> 
																		<select v-model="div" v-on:change="changeDiv"
																...
																<div class="input3" >
																	...
																	<span class="badge-dot badge-danger"></span> <label
																		for="measurecode1" class="col-form-label">조치코드</label> 
																		
																		<select id="measurecode1" type="text"  name="measurecode"
																		class="form-control">																		
																			<option value="">코드를 선택하세요.</option>						
																			<option v-for="c in clist" v-bind:value="c.codeno">{{c.codename}}</option>						
																		</select>
																</div>
...
/* 		$("#measurecode2").change(function() {
	...
	var vm = new Vue({
		...
		data:{div:"",
			clist:[]},
		methods:{
			changeDiv:function(e){
				{this.fetchCode();}
			},
			fetchCode:function(){ 
				this.clist=[];
				var url = "${path}/issue.do?method=codeList&codediv="+this.div;
				var vm = this; 
