...
public class SungbinService {
	...
	public ProjectSch totPieListJson(int year){
		return dao.totPieListJson(year);
	}
	public ArrayList<ProjectSch> totPieList2(){
		return dao.totPieList2();
	}
	...
	public ArrayList<Project> prolist2(int projectno){
		return dao.prolist2(projectno);
	}
	public Project latestprojectno() {
		return dao.latestprojectno();
	}
	...
	public void insertApp(Issue ins) {
		dao.insert(ins);		
	}	
	...
	public void insertMeasureApp(Issue ins) {
		dao.insertMeasure2(ins);
		dao.uptIssueState2(ins);
	}
	...
	public void uptIssueState2(Issue upt) {
		dao.uptIssueState2(upt);
	}
	public void updateIssue(Issue upt) {
		dao.updateIssue(upt);
		upload2(upt);
	}
	public void updateIssueApp(Issue upt) {
		dao.updateIssue(upt);
	}
	...
	public void updateMeasureApp(Issue upt) {
		dao.updateMeasure(upt);
	}
