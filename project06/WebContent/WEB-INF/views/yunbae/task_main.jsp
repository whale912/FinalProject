                        ...
                        <div class="row">                            
	                            ...
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
	                                        <span style="font-size:1rem;color:#6c757d">총 업무수</span><br>
                            ...
                            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
	                                        <span style="font-size:1rem;color:#6c757d">배정된 업무</span><br>
                            ...
                            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
	                                        <span style="font-size:1rem;color:#6c757d">승인된 업무</span><br>
                            ...
                            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
	                                        <span style="font-size:1rem;color:#6c757d">반려된 업무</span><br>
	                                        <div style="font-size:2rem;text-align:center;width:100%;">${RejectCount}</div>
	                                    </div>
                            ...
                            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
	                                        <span style="font-size:1rem;color:#6c757d">지연된 업무</span><br>
								...
								<div class="card" style="height:491px;">
									...
									<div class="card-body">
										<ul class="list-group">
											<c:forEach var="sche" items="${slist}">
												...
												<span style="float:right"><fmt:formatDate value="${sche.schedule}"/>
														...
														<c:if test="${schedule eq today }">
															<span class="badge badge-danger" style="float:right;margin-left:10px">Today</span>
														</c:if>
												</span>
												</li>
											</c:forEach>
	                                        ...
	                                        <li class="list-group-item list-group-item-info">업무일정</li>
...
<script src="${path}/a00_com/nav_bar.js"></script>
