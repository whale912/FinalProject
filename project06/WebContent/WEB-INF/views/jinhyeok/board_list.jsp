									...
									<form method="post" action="${path}/board.do?method=list">
														...
														<tbody>
															<c:forEach var="board" items="${blist}">
																...
																<tr  ondblclick="javascript:go(${board.pjboardno})"
																	...
																	<c:choose>
																		<c:when test="${board.noticetype eq 'Y'}">
																			<td width="55%" style="padding-left: 230px;"><span
																				class="badge badge-primary"
																				style="margin-right: 70px;">공지</span>${board.title} <span class="badge badge-danger" style="margin-left:10px;">&nbsp;${board.totrecnt}&nbsp;</span></td>
																		</c:when>
																		<c:otherwise>
										...
										<div class="search01" style="margin-top: 30px">
											...
											<input onkeyup="enterkey();" type="text" class="search02"
												name="title" placeholder="제목" /> <input
												onkeyup="enterkey();" type="text" class="search02"
												name="name" placeholder="작성자" /> <a href="#" id="srcBtn">검색</a>
