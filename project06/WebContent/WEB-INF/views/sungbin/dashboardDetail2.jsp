...
<style type="text/css">
	...
	#issueImg{width:270px;height:310px;}
	#issueDiv{width:100%;height:100%;text-align:center;padding-top:20px;}
</style>
	                                        ...
	                                        <div class="row">
					                            ...
					                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" style="width:50%">
					                                <div class="card" style="height:445px">
					                                    ...
					                                    <div class="card-body cbody0" style="height:374px;padding-top:20px;">
					                                    	<c:if test="${istatus.complete*1+istatus.wait*1+istatus.measuring*1!=0}">
					                                    	<div id="c3chart_pie"></div>
					                                    	</c:if>
					                                    	<c:if test="${istatus.complete*1+istatus.wait*1+istatus.measuring*1==0}">
					                                    	<div id="issueDiv"> 
					                                    	<img id="issueImg" src="${path}/a00_com/images/noneissue.png" />
					                                    	</div>
					                                    	</c:if>
