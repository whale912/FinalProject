										...
										<form method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="inputRight">
													<label for="inputText3" class="col-form-label">업무</label> <select
												...
												<div style="clear: both;">
													...
													<c:if test="${mem.authno==2}">
														...
														<div class="form-group">
															<div class="inputLeft">
																...
																<input readonly id="inputText3" name="mempno"
													...
													<c:if test="${mem.authno==4}">
														<div class="form-group">
															...
															<div class="input4" style="display:none;">
																<span class="badge-dot badge-danger"></span> <label
																	for="measurecode4" class="col-form-label">조치코드</label> <select
																	id="measurecode4" disabled  type="text"
																	class="form-control">																	
								                            		<option value="${issue.codeno}">${issue.codename}</option>																	
																</select>
															</div>
														...
														<div class="form-group">
															<div class="inputLeft">
																<label for="inputText3" class="col-form-label">담당자 (사번)</label>
																<input readonly id="inputText3" type="text"
																	class="form-control" value="${issue.mname}">
															</div>
															<div class="inputRight">
																<label for="inputText3" class="col-form-label">조치완료일</label>
																<fmt:formatDate var="measuredate"
														...
														<div style="clear: both;">
															...
															<c:forEach var="fname" begin="1" end="${issue.filenames2.size()}" varStatus="sts">
																<div class="form-group">
																	...
																	<div class="custom-file mb-3"
																		style="width: 50%; float: left;">
																		<!-- <input readonly type="file" name="report" disabled
																			class="custom-file-input" id="customFile"> <label
																			class="custom-file-label" for="customFile">첨부파일</label> -->
																	</div>
																</div>
...
<script type="text/javascript">
	$(document).ready(function() {
			...
			if (confirm("수정하시겠습니까?")) {
				if ($("[name=state]").val() != ""&& $("[name=measurecode]").val() != ""
					&& $("[name=mtitle]").val() != ""&& $("[name=mcontent]").val() != "") {
						...
						$("form").attr("action","${path}/issue.do?method=update");
						$("form").submit();
		...
		function addFileForm() {
			...
			html += "<input  type='file' name='report' class='custom-file-input' id='customFile'>";
			html += "<label class='custom-file-label' for='customFile'>첨부파일</label>";
...
/* 		function addFileForm() {
		...
		var selectDiv = ${issue.codediv};
		var selectCode = ${issue.codeno};
		var selectName = "${issue.codename}";
		...
		if(selectDiv==1){
			...
			$("#measurecode1").val(selectCode).attr("selected", "selected");
		...
		if(selectDiv==2){
			...
			$("#measurecode2").val(selectCode).attr("selected", "selected");
